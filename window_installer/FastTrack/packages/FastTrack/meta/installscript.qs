...
Component.prototype.createOperations = function()
{
    ...
    if (systemInfo.productType === "windows") {
        component.addOperation("CreateShortcut", "@TargetDir@/data/FastTrack.exe", "@StartMenuDir@/data/FastTrack.lnk",
            "workingDirectory=@TargetDir@","iconPath=@TargetDir@/data/icon.ico", "description=FastTrack");
        component.addOperation("CreateShortcut", "@TargetDir@/maintenancetool.exe", "@StartMenuDir@/data/FastTrackUpdater.lnk",
